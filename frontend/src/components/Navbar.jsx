          ...
          <div className="relative">
            ...
            {menuOpen ? (
              <div className="absolute right-0 mt-2 w-56 rounded-3xl border border-slate-200 bg-white p-3 shadow-lg">
                <Link to="/profile" className="block rounded-2xl px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">Trang cá nhân</Link>
                <Link to="/saved" className="block rounded-2xl px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">Đã lưu</Link>
                <Link to="/settings" className="block rounded-2xl px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">Cài đặt</Link>
                <Link to="/help" className="block rounded-2xl px-3 py-2 text-sm text-slate-700 hover:bg-slate-100">Trợ giúp</Link>
